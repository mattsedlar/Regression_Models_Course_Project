...
As the coefficients below show, with significance, each decrease in miles per gallon is accompanied by an increase in displacement, 0.028 cubic inches and `r 0.028 + 0.031` cubic inches for automatic and manual transmissions respectively.
